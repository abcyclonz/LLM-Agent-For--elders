          ...
          <div className="flex flex-col flex-1 w-full min-h-0 transition-smooth-slow">
            ...
            <div className="flex-1 min-h-0 overflow-y-auto flex flex-col items-center p-4">
              <div className="w-full max-w-2xl space-y-6">
                {messages.length === 0 && (
                  <div className="flex flex-col justify-center items-center min-h-[60vh] p-6 text-center max-w-2xl mx-auto bg-muted/10 rounded-lg transition-smooth hover:bg-muted/15 animate-smooth-fade-in hover-smooth">
